...
```
nmcli connection modify vlan-VLAN2001 ipv4.addresses 192.168.10.101/24 ipv4.method manual
...
3. Configure your bridge with a `bridge_port` which will be named after your RPN NIC, and your VLAN ID.
    <Lightbox src="scaleway_proxmox_rpn.webp" />
